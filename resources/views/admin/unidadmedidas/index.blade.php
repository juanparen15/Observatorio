...
@section('title','Lista Unidad de Medida')
@section('style')
<!-- SweetAlert2 -->
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Lista Unidad de Medidas</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Lista Unidad de Medidas</h3>
                  <div class="card-tools">

                     <a href="{{route('admin.unidadmedidas.create')}}" class="btn btn-primary">
                  ...
                  <table id="example2" class="table table-hover text-nowrap">
                    ...
                    <tbody>
                     ...
                     <tr>
                       ...
                       <td>{{$unidadmedida->nomUMed}}</td>
                       <td >
                           <form action="{{route('admin.unidadmedidas.destroy',$unidadmedida)}}" method="POST">
                              @csrf
                               @method('delete')

                               <a class="btn btn-primary btn-sm" href="{{route('admin.unidadmedidas.edit', $unidadmedida)}}">Editar</a>
...
<script>
    $(function() {
        ...
        Toast.fire({
            icon: 'success',
            title: 'La Unidad se Actualizo con Exito.'
        })
      });
</script>
@endif
...
<script>
    $(function() {
        ...
        Toast.fire({
            icon: 'success',
            title: 'La Unidad se Creó con Exito.'
        })
      });
</script>
@endif
...
<script>
    Swal.fire(
        '¡Eliminado!',
        'La Unidad se Eliminó con Exito.',
        'success'
      )
</script>
@endif
